    ...
    public List<Producer> getProducers(List<Producer> producers, int requiredEnergy) {
        List<Producer> arrangedProducers = producers.stream()
            ...
            public int compare(Producer o1, Producer o2) {
                if(GreenDetector.check(o1.getEnergyType()) && !GreenDetector.check(o2.getEnergyType())) {
                    return -1;
                } else if(!GreenDetector.check(o1.getEnergyType()) && GreenDetector.check(o2.getEnergyType())) {
                    return 1;
